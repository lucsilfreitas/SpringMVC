...
public class DepartamentoController {
	...
	public String salvar(Departamento departamento, RedirectAttributes attr) {
		...
		attr.addFlashAttribute("success", "Departamento incluso com sucesso!");
	...
	public String excluir(@PathVariable("id") Long id, ModelMap model) { //tem cargo verifica se tem cargo vinculado
